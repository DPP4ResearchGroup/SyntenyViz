---
title: "Explanatory Note: calculateOrthologSimilarity Function"
...
output: 
  rmarkdown::html_vignette:
    ...
    highlight: tango
vignette: >
  %\VignetteIndexEntry{Explanatory Note: calculateOrthologSimilarity Function}
...
# This is an explanatory vignette - no package loading required
# The vignette provides documentation and examples without executing code

# Simple validation to ensure vignette builds properly
cat("Explanatory vignette loaded successfully\n")
```
...
# Example function call (not executed in this explanatory vignette)
